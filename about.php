        ...
        <div class="carousel-testimony owl-carousel ftco-owl">
          <div class="item">
            <div class="testimony-wrap rounded text-center py-4 pb-5">
              <div class="user-img mb-2" style="background-image: url(asset/images/image_1.jpg)">
              </div>
              <div class="text pt-4">
          ...
          <div class="item">
            <div class="testimony-wrap rounded text-center py-4 pb-5">
              <div class="user-img mb-2" style="background-image: url(asset/images/customer2.jpg)">
              </div>
              <div class="text pt-4">
          ...
          <div class="item">
            <div class="testimony-wrap rounded text-center py-4 pb-5">
              <div class="user-img mb-2" style="background-image: url(asset/images/customer5.jpg)">
              </div>
              <div class="text pt-4">
          ...
          <div class="item">
            <div class="testimony-wrap rounded text-center py-4 pb-5">
              <div class="user-img mb-2" style="background-image: url(asset/images/customer4.jpg)">
              </div>
              <div class="text pt-4">
          ...
          <div class="item">
            <div class="testimony-wrap rounded text-center py-4 pb-5">
              <div class="user-img mb-2" style="background-image: url(asset/images/customer3.jpg)">
              </div>
              <div class="text pt-4">
                <p class="mb-4">Overall, my experience was exceptional. The vehicle surpassed expectations in cleanliness and upkeep, and the team exhibited professionalism and warmth. The return process was equally smooth, solidifying my loyalty to this service for future rentals.</p>
                <p class="name">Naman Sahu</p>
